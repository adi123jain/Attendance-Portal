...
function MonthlyAttendaceOutsource() {
  ...
  const monthlyAttendanceOutsource = () => {
    ...
    <>
      <Card>
        <Card.Header className="text-center text-primary p-3">
          ...
          >
            Monthly Attendance Sheet (Outsource Employee)
          </Typography>
        </Card.Header>
        ...
        <Card.Footer className="text-center p-3">
          <Button
            onClick={monthlyAttendanceOutsource}
            variant="outlined"
...
export default MonthlyAttendaceOutsource;
